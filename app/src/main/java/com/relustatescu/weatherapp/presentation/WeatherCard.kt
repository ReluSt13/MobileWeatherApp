...
import com.relustatescu.weatherapp.R
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    state.locationInfo?.location?.let {
                        Text(
                            text = it,
                            color = Color.White
                        )
                ...
                Spacer(modifier = Modifier.height(16.dp))
                Text(
                    text = "Feels like ${data.apparentTemperatureC}°C",
                    fontSize = 10.sp,
                    color = Color.White
                )
                ...
                Row(
                    ...
                    WeatherDataDisplay(
                        value = data.precipitationProbability.roundToInt(),
                        unit = "%",
